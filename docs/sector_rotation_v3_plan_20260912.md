...
状态：**开发依据文档**。P0–P3 在分支 `cursor/sector-rotation-v3-99b0`（PR #7）有实现，但**不能视为已完成验收**。P4.0 时间线、P4.1 相对强弱—速度轨迹、P4.2 当日热力图与 P4.3 跨资产 ETF 代理条已落地；**不得开始 P5.1 FRED**。关键闭环、真实量价抽样、17 ETF 活样本与回退演练仍待 SG 兑现。后续板块轮动的迭代严格按本文推进；偏离本文的改动需要先更新本文再实施。
...
代码上 P4.0–P4.3 已落地。以下仍未做，也不在本步做：
