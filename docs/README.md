...
- [`sector_rotation_v3_plan_20260912.md`](sector_rotation_v3_plan_20260912.md)：**当前开发依据**。P0–P3 有实现但未完成发布/数据链验收；P4.0 时间线与 P4.1 轨迹图已落地，P4.2 热力图 / P5.1 FRED 仍未开始。实施状态见该文 §10。
