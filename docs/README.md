...
- [`sector_rotation_v3_plan_20260912.md`](sector_rotation_v3_plan_20260912.md)：**当前开发依据**。P0–P3 有实现但未完成发布/数据链验收；P4.0–P4.3 呈现层已收口。阶段性总结见该文 **§11**，实施状态见 **§10**。P5.1 FRED 未开始。
